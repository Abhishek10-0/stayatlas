...
const usersData = [
  ...
  },
  {
    ...
    bookingHistory: [
      { room: "Room 405", date: "2023-08-05", nights: 4, status: "Upcoming" },
      { room: "Room 408", date: "2023-09-12", nights: 2, status: "Completed" },
      { room: "Room 501", date: "2023-10-01", nights: 5, status: "Completed" }
    ],
    isBanned: false,
  },
  // ... (rest of the users with updated bookingHistory structure)
];
