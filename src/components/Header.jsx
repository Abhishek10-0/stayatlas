  ...
  return (
    <header className="bg-black sticky top-0 z-50 shadow-md">
      <div className="max-w-[2560px] mx-auto flex justify-between items-center py-5 px-6 md:px-20">
        ...
        {/* Simple Mobile Dropdown (Right side only) */}
        <div className="md:hidden relative">
          ...
          {isMobileDropdownOpen && (
            <div className="absolute right-0 mt-2 bg-white text-gray-800 min-w-[180px] shadow-xl rounded-xl overflow-hidden z-50">
              <a href="/" className="block px-4 py-3 hover:bg-blue-500 hover:text-white transition-all duration-200">HOME</a>
              {/* <a href="#" className="block px-4 py-3 hover:bg-blue-500 hover:text-white transition-all duration-200">Panvel</a> */}
              {/* <a href="#" className="block px-4 py-3 hover:bg-blue-500 hover:text-white transition-all duration-200">Khanavale</a> */}
              {/* <a href="#" className="block px-4 py-3 hover:bg-blue-500 hover:text-white transition-all duration-200">Pool Homes</a> */}
              <a href="https://wa.me/918591131447" target="_blank" rel="noopener noreferrer" className="block px-4 py-3 hover:bg-blue-500 hover:text-white transition-all duration-200">CONTACT US</a>
            </div>
          )}
        </div>
      </div>
