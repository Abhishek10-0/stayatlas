...
//   return (
//     <div className="bg-white py-5 px-[5%] mx-auto max-w-[2560px]">
//       {/* Grid Gallery */}
...
//             <button
//               onClick={showPrev}
//               className="cursor-pointer absolute left-5 top-1/2 transform -translate-y-1/2 text-white text-3xl"
//             >
//               <FaChevronLeft />
//             </button>
//             <img
...
//             <button
//               onClick={showNext}
//               className="cursor-pointer absolute right-5 top-1/2 transform -translate-y-1/2 text-white text-3xl"
//             >
//               <FaChevronRight />
//             </button>
//           </div>
