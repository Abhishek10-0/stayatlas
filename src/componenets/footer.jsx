    ...
    return (
      <footer className="bg-[#3d3c3c] text-white py-10 text-center w-full">
        <div className="container mx-auto w-[80%]">
          <h3 className="text-2xl mb-5 pb-2.5 border-b-2 border-white">
          ...
          <div className="mt-8 flex justify-center gap-4 text-2xl">
            {[
              { icon: 'whatsapp', link: 'https://wa.me/918591131447' },
              { icon: 'instagram', link: 'https://www.instagram.com/stayatlas.in' },
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className={`fab fa-${social.icon} hover:text-[#ffcc00] transition-colors duration-300`}
          ...
          <div className="mt-5 pt-4 border-t border-white/10 text-sm">
            <p>&copy; {new Date().getFullYear()} Staysatlas | All rights reserved.</p>
          </div>
        </div>
      </footer>
    );
