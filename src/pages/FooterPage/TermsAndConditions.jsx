...
import TopMiniLinks from '../../components/TopMiniLinks';
...
const TermsAndConditions = () => {
  return (
    <div className="min-h-screen bg-[#f5f5f5] py-10">
      ...
      <div className="max-w-[90%] md:max-w-5xl mx-auto mt-4 p-6 md:p-10 bg-white text-black rounded-xl shadow-lg animate-fadeIn border border-black/20 shadow-xl">
