...
const CancellationPolicy = () => {
  return (
    <div className="min-h-screen bg-[#f5f5f5] py-10">
      ...
      {/* Main Cancellation Policy Box */}
      <div className="max-w-4xl mx-auto bg-white text-black p-8 rounded-lg shadow-lg mt-4">
        <h1 className="text-3xl md:text-4xl font-bold mb-6 text-center">Cancellation Policy</h1>

        <h2 className="text-2xl font-semibold mt-8 mb-4">1. Standard Cancellation Policy</h2>
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4">2. Refund Processing & Cancellation Fees</h2>
        <ul className="list-disc list-inside mb-6 space-y-2 text-base leading-relaxed">
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4">3. Non-Cancellable Bookings & Peak Dates</h2>
        <ul className="list-disc list-inside mb-6 space-y-2 text-base leading-relaxed">
          ...
          <li>Cancellations are not permitted for peak dates, including:
            <ul className="list-disc list-inside ml-6 mt-2 space-y-1 text-base leading-relaxed">
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4">4. Last-Minute Cancellations & Extenuating Circumstances</h2>
        <ul className="list-disc list-inside mb-6 space-y-2 text-base leading-relaxed">
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4">5. Refund for Extra Charges</h2>
        <ul className="list-disc list-inside mb-6 space-y-2 text-base leading-relaxed">
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4">6. Cancellation by Stay Atlas</h2>
        <ul className="list-disc list-inside mb-6 space-y-2 text-base leading-relaxed">
          <li>In rare cases where Stay Atlas needs to cancel or reschedule a booking due to unavoidable circumstances, Guests will have the option to:
            <ol className="list-decimal list-inside ml-6 mt-2 space-y-1 text-base leading-relaxed">
